...
import com.example.mobilproje.Adapter.SizeAdapter;
...
import com.example.mobilproje.Fragment.DescriptionFragment;
import com.example.mobilproje.Fragment.ReviewFragment;
import com.example.mobilproje.Fragment.SoldFragment;
import com.example.mobilproje.Helper.ManagmentCart;
import com.example.mobilproje.databinding.ActivityDetailBinding;
...
public class DetailActivity extends BaseActivity {
    ...
    private void setupViewPager(){
        ...
        adapter.addFrag(tab1,"Açıklamalar");
        adapter.addFrag(tab2,"Yorumlar");
        adapter.addFrag(tab3,"Satıldı");
